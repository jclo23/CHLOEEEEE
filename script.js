...
function getRecommendations(skinType) {
    switch (skinType) {
        case 'sensitive': return [
            { name: "Calming Moisturizer", image: "product1.jpg", description: "Perfect for sensitive skin." },
            { name: "Gentle Cleanser", image: "product2.jpg", description: "A mild cleanser for sensitive skin." }
        ];
        case 'dry': return [
            { name: "Hydrating Serum", image: "product3.jpg", description: "Deep hydration for dry skin." },
            { name: "Moisturizing Cream", image: "product4.jpg", description: "Rich cream for moisture." }
        ];
        case 'oily': return [
            { name: "Oil-Free Cleanser", image: "product5.jpg", description: "For oily and acne-prone skin." },
            { name: "Mattifying Gel", image: "product6.jpg", description: "Reduces excess oil." }
        ];
        case 'aging': return [
            { name: "Anti-Aging Cream", image: "product7.jpg", description: "Reduces fine lines and wrinkles." },
            { name: "Retinol Serum", image: "product8.jpg", description: "Promotes skin renewal." }
        ];
        default: return [];
    }
}
